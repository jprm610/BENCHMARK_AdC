 ...
 *   bs        : tiling block size, multiple of 8 (default: 64)
 *
 * Thread count is read from OMP_NUM_THREADS (OpenMP runtime default
...
int main(int argc, char **argv)
{
    ...
    fprintf(stderr,
            ...
            (unsigned long long)bs, omp_get_max_threads());
