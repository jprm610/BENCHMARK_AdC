/*
 * test_kernel_avx2_morton.c - Unit test for the 4x16 AVX2 microkernel
 * declared in kernel_avx2_morton.h (header-only static inline). Pair
 * with test_kernel_avx2_tiled.c, which exercises the sibling 6x16
 * microkernel in kernel_avx2_tiled.h.
 *
