/*
 * matmul_tiled.h - Explicitly tiled ikj matrix multiplication.
 *
...
#ifndef MATMUL_TILED_H
#define MATMUL_TILED_H

#include <stddef.h>
#include "matmul_naive.h"   /* scalar_t */

#define TILED_MC_DEFAULT 256u
#define TILED_KC_DEFAULT 256u

/*
 * matmul_tiled: compute C = A * B with explicit Mc x Kc blocking.
 *
 * Uses TILED_MC_DEFAULT and TILED_KC_DEFAULT as tile sizes.
...
/*
 * benchmark_iterations_tiled: same semantics as benchmark_iterations
 * (matmul_naive.h) but delegates each A*B step to matmul_tiled.
 *
