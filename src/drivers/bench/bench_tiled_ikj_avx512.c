/*
 * bench_tiled_ikj_avx512.c - Benchmark driver for matmul_tiled_ikj_avx512.
 *
 * Usage:
 *   bench_tiled_ikj_avx512_O3 <m> [num_iters] [num_runs] [bs]
 *
 ...
 *   bs        : AVX-512 tiling block size, multiple of 8 (default: 64)
 *
 * Output (one CSV line on stdout):
 *   tiled_ikj_avx512,m,n,num_iters,bs,median_seconds,gflops
 *
...
int main(int argc, char **argv)
{
    ...
    if (argc >= 5) {
        ...
        matmul_tiled_ikj_avx512_set_bs((size_t)bs_in);
    }

    size_t bs = g_tiled_ikj_avx512_bs;
    ...
    benchmark_iterations_tiled_ikj_avx512(B_out, A, Z, m, n, 1);
    ...
    for (size_t r = 0; r < num_runs; ++r) {
        ...
        benchmark_iterations_tiled_ikj_avx512(B_out, A, Z, m, n, I_meas);
    ...
    printf("tiled_ikj_avx512,%llu,%llu,%llu,%llu,%.6f,%.6f\n",
