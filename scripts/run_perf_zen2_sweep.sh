...
VARIANTS=(${VARIANTS:-naive recursive morton morton_avx2 morton_omp loop_ijk loop_ikj loop_jik loop_jki loop_kij loop_kji tiled_ikj tiled_ikj_avx2 tiled_ikj_omp})
